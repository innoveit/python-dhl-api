...
class DHLAddedService:
    ...
    def __init__(
        self, service_code, value=None, currency=None, method=None, dangerous_goods=None
    ):
...
class DHLShipmentOutput:
    def __init__(
        ...
        self.split_transport_and_waybill_doc_labels = (
            split_transport_and_waybill_doc_labels
        )
...
class DHLShipment:
    ...
    def __init__(
        ...
        sender_registration_numbers=None,
...
class DHLDocument:
    def __init__(
        self,
        tracking_number,
        original_planned_shipping_date,
        product_code,
        document_images,
        accounts,
    ):
